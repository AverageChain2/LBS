...
public class DomainEventManager { //change name to DomainEventManager
    ...
    private void sendRemoteEvent(Event event){
        sender.convertAndSend(Objects.requireNonNull(env.getProperty("rabbitmq.appUser_exchange")),
                                    Objects.requireNonNull(env.getProperty("rabbitmq.newAppUserKey")), event);
