...
public class EventStoreJpa {
    ...
    @Id
    @Column(name="id")
    @SequenceGenerator(name= "event_store_sequence",sequenceName = "event_store_sequence_id",allocationSize = 1)
    ...
    protected EventStoreJpa(){}
        ...
        public EventStoreJpa(LocalDate occurredOn, String eventBody, String eventType) {
