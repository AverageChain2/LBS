...
public class LeaveRejectedOrCancelledDomainEventMapper {
    ...
    public LeaveBalance getLeaveBalanceFromRejectedEvent(LeaveRejectedEvent event){
    ...
    public LeaveBalance getLeaveBalanceFromApprovedEvent(LeaveRejectedEvent event){
